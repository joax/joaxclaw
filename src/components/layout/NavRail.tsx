import { MessageSquare, Bot, ClipboardList, Settings, Palette, HelpCircle, Puzzle, Timer } from 'lucide-react'
import type { NavSection } from '../../App'

interface NavItem { id: NavSection; icon: React.ReactNode; label: string }
...
interface Props { section: NavSection; onNavigate: (s: NavSection) => void }

export function NavRail({ section, onNavigate }: Props) {
  return (
    <nav
